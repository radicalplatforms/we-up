        ...
        <>
                    {/* Group Info + Prompt */}
                        ...
                        <div className="pt-2 pb-3 md:flex text-center md:items-center md:justify-between">
                            <h1 className="lowercase text-2xl font-semibold leading-tight text-gray-900 sm:text-3xl md:text-4xl">My <mark className="px-2 text-white bg-blue-600 rounded">Wakeup Times</mark></h1>
                        ...
                        <div>
                            <h1 className="lowercase text-2xl text-center mb-1 p-4 font-semibold leading-none tracking-tight text-gray-900 md:text-5xl lg:text-6xl dark:text-white">Today&apos;s <mark className="px-2 text-white bg-blue-600 rounded dark:bg-blue-500">Prompt</mark></h1>
                        </div>
